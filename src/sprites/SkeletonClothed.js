...
export default class SkeletonClothed extends Enemy {
  constructor (config) {
    super(config);
    this.body.setVelocity(0,0).setBounce(0, 0).setCollideWorldBounds(false);
    this.anims.play('skeleton-clothed-1');
    this.killAt = 0;
  }
  ...
  update (time, delta) {
    ...
    // The Gato stopped, better try to walk in the other direction.

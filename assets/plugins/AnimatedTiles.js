                ...
                AnimatedTiles.prototype = {
                    ...
                    setRate: function setRate(rate) {
                        ...
                        if (gid === null) {
                            ...
                            if (map === null) {
                                this.animatedTiles.forEach(function(
                                    animatedTiles
                                ) {
                    ...
                    resetRates: function resetRates() {
                        ...
                        if (mapIndex === null) {
                            ...
                            this.animatedTiles.forEach(function(mapAnimData) {
                                mapAnimData.rate = 1;
                                mapAnimData.animatedTiles.forEach(function(
                                    tileAnimData
                                ) {
                                    tileAnimData.rate = 1;
                                });
                        ...
                        this.animatedTiles.forEach(function(mapAnimData) {
                            ...
                            mapAnimData.animatedTiles.forEach(function(
                                ...
                                if (animatedTile.next < 0) {
                                    ...
                                    var oldTileId =
                                        animatedTile.frames[currentIndex]
                                            .tileid;
                                    ...
                                    //this.updateLayer
                                    animatedTile.tiles.forEach(function(
                                        layer,
                                        layerIndex
                                    ) {
                                        if (
                                            !mapAnimData.activeLayer[layerIndex]
                                        ) {
                                            return;
                                        }
                                        _this3.updateLayer(
                    ...
                    updateLayer: function updateLayer(animatedTile, layer) {
                        ...
                        var tilesToRemove = [];
                        var tileId =
                            animatedTile.frames[animatedTile.currentFrame]
                                .tileid;
                    ...
                    updateAnimatedTiles: function updateAnimatedTiles() {
                        ...
                        container.forEach(function(mapAnimData) {
                            ...
                            mapAnimData.animatedTiles.forEach(function(
                                ...
                                tileAnimData.tiles.forEach(function(
                                    tiles,
                                    layerIndex
                                ) {
                                    var layer =
                                        mapAnimData.map.layers[layerIndex];
                                    ...
                                    for (
                                        ...
                                        for (
                                            ...
                                            var tile =
                                                mapAnimData.map.layers[
                                                    layerIndex
                                                ].data[_x9][_y];
                                            // should this tile be animated?
                                            if (
                                                tile.index == tileAnimData.index
                                            ) {
